...
lua_shared_dict kong_consumers_db_cache     ${{MEM_CACHE_SIZE}};
lua_shared_dict kong_consumers_db_cache_miss 12m;
lua_shared_dict kong_credentials_db_cache     128m;
lua_shared_dict kong_credentials_db_cache_miss 12m;
