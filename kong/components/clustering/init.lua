...
local events = require("kong.components.clustering.events")
local clustering_tls = require("kong.components.clustering.tls")
...
function _M:init_cp_worker(basic_info)
  ...
  self.instance = require("kong.components.clustering.control_plane").new(self)
...
function _M:init_dp_worker(basic_info)
  ...
  self.instance = require("kong.components.clustering.data_plane").new(self)
  self.instance:init_worker(basic_info)
end
