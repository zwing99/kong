...
if kong_router_flavor ~= "traditional" then
  ...
  local get_schema = require("kong.internal.router.atc").schema
  local get_expression = kong_router_flavor == "traditional_compatible" and
                         require("kong.internal.router.compat").get_expression or
                         require("kong.internal.router.expressions").transform_expression
...
-- router_flavor in ('traditional_compatible', 'traditional')
  ...
  if kong_router_flavor == "traditional_compatible" then
    local is_empty_field = require("kong.internal.router.transform").is_empty_field
