...
function DB.new(kong_config, strategy)
  ...
  do
    ...
    for _, entity_name in ipairs(constants.CORE_ENTITIES) do
      local entity_schema = require("kong.components.datastore.schema.entities." .. entity_name)
      ...
      local subschemas
      ok, subschemas = load_module_if_exists("kong.components.datastore.schema.entities." .. entity_name .. "_subschemas")
      if ok then
...
do
  -- migrations
  local MigrationsState = require "kong.components.datastore.migrations.state"
