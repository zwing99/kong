...
local Migration = require "kong.components.datastore.schema.others.migrations"
...
local function load_subsystems(db, plugin_names)
  ...
  local subsystems = require("kong.components.datastore.migrations.subsystems")
...
--   namespace = "kong.components.datastore.migrations.core", -- or some other plugin namespace,
