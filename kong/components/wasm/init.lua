...
local json_schema = require "kong.components.datastore.schema.json"
local pl_file = require "pl.file"
local pl_path = require "pl.path"
local constants = require "kong.constants"
local properties = require "kong.components.wasm.properties"
...
local function register_property_handlers()
  ...
  properties.add_getter("kong.internal.router.route", function(kong)
  ...
  properties.add_getter("kong.internal.router.service", function(kong)
