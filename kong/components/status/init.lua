...
api_helpers.attach_routes(app, require "kong.components.restful.routes.health")
api_helpers.attach_routes(app, require "kong.components.status.ready")
...
if kong.configuration.database == "off" then
  ...
  for route_path, definition in pairs(require "kong.components.restful.routes.upstreams") do
