...
local upstreams = require "kong.internal.balancer.upstreams"
local targets
...
local function create_balancer_exclusive(upstream)
  ...
  if algorithm_types == nil then
    algorithm_types = {
      ["consistent-hashing"] = require("kong.internal.balancer.consistent_hashing"),
      ["least-connections"] = require("kong.internal.balancer.least_connections"),
      ["round-robin"] = require("kong.internal.balancer.round_robin"),
      ["latency"] = require("kong.internal.balancer.latency"),
    }
  end
