...
local proc_mgmt = require "kong.internal.plugin_servers.process"
...
local protocol_implementations = {
  ["MsgPack:1"] = "kong.internal.plugin_servers.mp_rpc",
  ["ProtoBuf:1"] = "kong.internal.plugin_servers.pb_rpc",
}
