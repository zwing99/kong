...
local utils       = require("kong.internal.router.utils")
...
local FLAVOR_TO_MODULE = {
  traditional            = "kong.internal.router.traditional",
  expressions            = "kong.internal.router.expressions",
  traditional_compatible = "kong.internal.router.compat",
}
