    ...
    s[s_len] = {
        ...
        route      = {
          ...
          expression = [[http.path.segments_n == 6
                         && http.path.segments.0 == "service-0"
                         && http.path.segments.1 == "api"
                         && http.path.segments.2 == "v1"
                         && http.path.segments.3 == "mockroute-0"
    ...
    s[s_len] = {
        ...
        route      = {
          ...
          expression = [[http.path.segments_n == 6
                         ...
                         && http.path.segments.1 == "api"
                         && http.path.segments.2 == "v1"
                         && http.path.segments.3 == "mockroute-1"
                         && http.path.segments.5 == "mockpath"
                       ]],
          hosts = { "service.a.api.v1.mockroute.a.mockpath",
                    "dataplane.kong.benchmark.svc.cluster.local",
        ...
        s[s_len] = {
            ...
            route      = {
              ...
              expression = string.format([[http.path.segments_n == 6
                             && http.path.segments.0 == "service-%d"
                             && http.path.segments.1 == "api"
                             && http.path.segments.2 == "v1"
                             && http.path.segments.3 == "mockroute-0"
                             && http.path.segments.5 == "mockpath"
            ...
            s[s_len] = {
                ...
                route      = {
                  ...
                  expression = string.format([[http.path.segments_n == 6
                                 ...
                                 && http.path.segments.1 == "api"
                                 && http.path.segments.2 == "v1"
                                 && http.path.segments.3 == "mockroute-%d"
                                 && http.path.segments.5 == "mockpath"
                               ]], i, j),
                  hosts = { "service.a.api.v1.mockroute.a.mockpath",
                            "dataplane.kong.benchmark.svc.cluster.local",
