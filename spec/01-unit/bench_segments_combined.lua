...
function generate_scenarios(routes)
    ...
    s[s_len] = {
        ...
        route      = {
          id = uuid(),
          paths    = { "~/(?<all>service-0/api/v1/mockroute-0/[^/]+/(?<part>mockpath/?))$" },
          expression = [[http.path.segments_n == 6
                         && http.path.segments.0_3 == "service-0/api/v1/mockroute-0"
                         && http.path.segments.5 == "mockpath"
                       ]],
    ...
    s[s_len] = {
        ...
        route      = {
          id = uuid(),
          paths    = { "~/(?<all>service-0/api/v1/mockroute-1/[^/]+/(?<part>mockpath/?))$" },
          expression = [[http.path.segments_n == 6
                         && http.path.segments.0_3 == "service-0/api/v1/mockroute-1"
                         && http.path.segments.5 == "mockpath"
                       ]],
          hosts = { "service.a.api.v1.mockroute.a.mockpath",
                    "dataplane.kong.benchmark.svc.cluster.local",
    ...
    for i = 1, routes * 0.05 / 10 - 1 do
        ...
        s[s_len] = {
            ...
            route      = {
              id = uuid(),
              paths    = { "~/(?<all>service-" .. i .. "/api/v1/mockroute-0/[^/]+/(?<part>mockpath/?))$" },
              expression = string.format([[http.path.segments_n == 6
                             && http.path.segments.0_3 == "service-%d/api/v1/mockroute-0"
                             && http.path.segments.5 == "mockpath"
                           ]], i),
              hosts = { "service.a.api.v1.mockroute.a.mockpath",
                        "dataplane.kong.benchmark.svc.cluster.local",
        ...
        for j = 1, 4 do
            ...
            s[s_len] = {
                ...
                route      = {
                  ...
                  expression = string.format([[http.path.segments_n == 6
                                 && http.path.segments.0_3 == "service-%d/api/v1/mockroute-%d"
                                 && http.path.segments.5 == "mockpath"
                               ]], i, j),
                  hosts = { "service.a.api.v1.mockroute.a.mockpath",
                            "dataplane.kong.benchmark.svc.cluster.local",
        ...
        for j = 5, 10 do
            ...
            s[s_len] = {
                ...
                route      = {
                  id = uuid(),
                  paths    = { "~/service-" .. i .. "/api/v1/mockroute-" .. j .. "/mockpath/?$" },
                  expression = string.format([[http.path == "/service-%d/api/v1/mockroute-%d/mockpath/"
                                               || http.path == "/service-%d/api/v1/mockroute-%d/mockpath"
                               ]], i, j, i, j),
                  hosts = { "service.a.api.v1.mockroute.a.mockpath",
                            "dataplane.kong.benchmark.svc.cluster.local",
                            "dataplane.kong.benchmark.svc",
